package com.lmmarketings.trackit
...
import com.lmmarketings.trackit.backend.BackEnd
import com.lmmarketings.trackit.user.FrontEnd
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.frontend).setOnClickListener{
            startActivity(Intent(this,BackEnd::class.java))
        }
        findViewById<Button>(R.id.backend).setOnClickListener {
            startActivity(Intent(this, FrontEnd::class.java))
        }
